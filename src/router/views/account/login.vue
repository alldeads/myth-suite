        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6 col-xl-5">
                        ...
                        <div class="row">
                            <div class="col-7">
                                <div class="text-primary p-4">
                                    ...
                                    <p>Sign in to continue to Myth.</p>
                                </div>
                            </div>
                    ...
                    <div class="card-body pt-0">
                        ...
                        <div v-if="isAuthError">
                            <b-alert v-model="isAuthError" variant="danger" class="mt-3" dismissible>
                                {{authError.message}} <span>{{authError.errors}}</span>
                            </b-alert>
                        </div>

                        <b-form class="p-2" @submit.prevent="tryToLogIn">
                            <b-form-group id="input-group-1" label="Email" label-for="input-1">
                                <b-form-input id="input-1" v-model="auth.email" type="text" placeholder="Enter email"></b-form-input>
                            </b-form-group>
                ...
                <div class="mt-5 text-center">
                    ...
                    <p>
                        © {{new Date().getFullYear()}} Upraise. Crafted with
                        <i class="mdi mdi-heart text-danger"></i> by Myth Labs
                    </p>
                </div>
                <!-- end row -->
            </div>
